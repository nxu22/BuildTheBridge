...
export default function CanadianServicePage() {
  const content = {
    ...
    features: [
      { title: "Market Research", desc: "Find the best international markets for your brand." },
      { title: "Brand Positioning", desc: "Use your Canadian heritage as a competitive advantage." },
      { title: "International Presence", desc: "Build your digital presence worldwide." },
    ],
    process: ["Market Analysis", "Brand Strategy", "Digital Setup", "Global Launch"],
    cta: { title: "Ready to Go Global?", button: "Get Started", backButton: "← Back" },
  };
